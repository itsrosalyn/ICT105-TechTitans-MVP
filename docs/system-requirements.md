...
| FR-11 | Confirmation or feedback message | Confirmation Page | Completed | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/confirmation-page.png" width="100%" /> | Users receive immediate confirmation after successful attendance submission. |
...
| FR-13 | Basic user interface consistency | Shared Navigation, Buttons, Fonts, and Color Theme | Completed | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/home-page.png" width="100%" /><br><img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/lecturer-dashboard.png" width="100%" /> | The prototype uses consistent navigation, fonts, buttons, and status colors across the student and lecturer pages. |
| FR-14 | Mobile-friendly or responsive design | Student Mobile Layout / Lecturer Desktop Layout | Completed | <img width="746" height="1280" alt="Mobile View" src="https://github.com/user-attachments/assets/a5fac736-0d48-49ae-ab7e-f66c8bb572d0" /><br><img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/lecturer-dashboard.png" width="100%" /> | Student pages are optimized for mobile screens, while the lecturer dashboard is designed for desktop use. |
| FR-15 | Privacy and responsible data handling | Consent and Data Collection Documentation | Completed | [User Consent Statement](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/docs/user-consent-statement.md)<br>[Data Inventory](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/data/data-inventory.csv) | The system collects only necessary attendance data and does not use permanent background location tracking. |
| FR-16 | Final prototype traceability | Requirement Traceability and Full System Flow | Completed | [Implementation Flow](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/diagrams/implementation-flow.mmd)<br>[Requirement Traceability Matrix](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/docs/requirement-traceability-matrix.md) | Final prototype screens and modules are mapped to the system requirements and core MVP features. |
