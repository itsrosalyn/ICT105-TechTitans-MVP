...
| FR-07 | Detail view | Attendance Record Details | Partial | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/records-page.png" width="100%" /> | Basic record information is available, but detailed attendance information is still under development. |
| FR-08 | Status/progress tracking | Attendance Tracker | Partial | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/acea8f4718f4ca15dde3e6e01ae53ceafa7fb432/screenshots/qr-generation.png" width="100%" /> | Dashboard displays attendance statistics, but the automatic 80% attendance progress tracker is not fully implemented. |
