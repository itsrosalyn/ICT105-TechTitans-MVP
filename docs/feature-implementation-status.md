...
|---|---|---|---|---|---|---|---|
| FR-01 | Homepage or landing screen | home-page.html | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/home-page.png" width="100%" /> | None |
| FR-02 | Primary user pathway | Student QR Scanner & Lecturer Attendance Dashboard | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/scanqr-page.png" width="100%" /><br><img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/wireframes/lecturer-dashboard.png" width="100%" /> | None |
| FR-03 | User input/submission | One-Touch Check-in (Logged-in Student & GPS) | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/confirmation-page.png" width="100%" /> | None |
| FR-04 | Data storage/record management | Data Layer | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img width="1280" height="727" alt="Firebase data" src="https://github.com/user-attachments/assets/980f35cb-f369-4ed7-b728-7ae88f62b334" /> | None |
| FR-05 | View records/list | Lecturer Roster View (ICT 105) | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/lecturer-dashboard.png" width="100%" /> | None |
| FR-06 | Search/filter/category | Student Attendance History | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/records-page.png" width="100%" /> | None |
| FR-07 | Detail view | Student Attendance Detail Modal | Working Draft | Completed | Pan Thway Chal Ko Ko Lwin | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/records-page.png" width="100%" /> | Detail view will be accessed from the attendance records page. The modal will display attendance status, submission time, course information, and GPS validation in the next sprint. |
| FR-08 | Status/progress tracking | Real-time Attendance Counter | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/lecturer-dashboard.png" width="100%" /> | None |
| FR-09 | Admin/manager function | Lecturer Session Management Panel | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/qr-generation.png" width="100%" /> | None |
| FR-10 | Validation/error prevention | Geofence Proximity Check & Duplicate Check | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/gpscheck-page.png" width="100%" /> | None |
| FR-11 | Confirmation/feedback message | Scan Success Toast/Alert Message | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/confirmation-page.png" width="100%" /> | None |
| FR-12 | Dashboard/analytics view | Lecturer Class Summary Screen | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/lecturer-dashboard.png" width="100%" /> | None |
| FR-13 | UI consistency | Shared Navigation Bar & Color Theme | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | [UI Consistency](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/prototype/styles.css) | None |
| FR-14 | Mobile/responsive consideration | Student Mobile Viewport Layout | Completed | Completed | **Pan Thway Chal Ko Ko Lwin** | <img width="746" height="1280" alt="Mobile View" src="https://github.com/user-attachments/assets/a5fac736-0d48-49ae-ab7e-f66c8bb572d0" /> | None |
| FR-15 | Privacy/responsible data handling | Data Collection | Completed | Completed | **Phoo Myat Thwin** | [User Consent Statement](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/docs/user-consent-statement.md)<br>[Data Inventory](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/data/data-inventory.csv) | None |
| FR-16 | Final prototype traceability | Full System Flow | Completed | Completed | **Thun Thiri Khin** | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/privacy-security-review.png" width="100%" /> | None |Thwin | Mermaid implementation flow, `implementation-plan.md`,`feature-implementation-status.md`, and requirement mapping documents. | Verify all requirements are fully traceable during Lab 11. |
