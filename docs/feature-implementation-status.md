...
| FR-02 | Primary user pathway | Student QR Scanner & Lecturer Attendance Dashboard |  | <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/screenshots/scanqr-page.png" width="100%" /> <img src="https://github.com/itsrosalyn/ICT105-TechTitans-MVP/blob/main/wireframes/lecturer-dashboard.png" width="100%" /> | Ensure smooth screen transition after successful scan |
...
| FR-04 | Data storage or simulated storage | Firebase Realtime Database |  |  | Enforce secure database security rules |
...
| FR-13 | UI consistency | Shared Navigation Bar & Color Theme (CSS Stylesheet) |  | [UI Consistency](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/tree/main/prototype) | Standardize button padding and font hierarchy across screens |
| FR-14 | Mobile-friendly/responsive design | Student Mobile Viewport Layout |  |  | Ensure camera viewfinder resizes properly on smaller screens |
