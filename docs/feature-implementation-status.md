...
| FR-13 | UI consistency | Shared Navigation Bar & Color Theme (CSS Stylesheet) | Completed | [UI Consistency](https://github.com/itsrosalyn/ICT105-TechTitans-MVP/tree/main/prototype) | None |
