...
| --------- | ------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------- |
| **M-01**  | Landing page views  | Number of visitors who open the AttendQR landing page.                           | Count total page visits using Netlify Analytics or manual tracking. | Netlify Analytics or manual tracking spreadsheet.                      | **At least 30 landing page views.**         |
| **M-02**  | CTA clicks          | Number of visitors who click the **"Try the Demo"** button.                      | (CTA Clicks ÷ Landing Page Views) × 100                             | **Firebase Firestore (`attendqr/counters`) or localStorage fallback.** | **At least 50% of visitors click the CTA.** |
| **M-03**  | Demo attempts       | Number of visitors who click **"Open Prototype Demo"** and access the prototype. | Count total prototype launches.                                     | **Firebase Firestore (`attendqr/counters`) or localStorage fallback.** | **At least 15 demo attempts.**              |
| **M-04**  | Feedback responses  | Number of users who provide feedback after using the prototype.                  | Count submitted feedback responses.                                 | Feedback form or manual feedback record.                               | **At least 20 responses.**                  |
