...
- **Prototype platform/tool:** HTML, CSS, JavaScript, Firebase Authentication, Firebase Firestore, GitHub Pages, Netlify
- **Landing Page:** https://attendqr-landingpage.netlify.app/
- **Final prototype URL:** https://attend-qr-1.netlify.app

- **Login/access instructions if needed:**
  - Click **Try Demo** on the landing page to open the prototype.
